Attribute VB_Name = "WINAPIDeclares"
Option Explicit


'© 2001-2003 Intuit Inc. All rights reserved.
...
String, ByVal lOptionalLength As Long) As Long
...
(ByVal hInternet As Long, ByVal lOption As Long, ByVal sbuffer As String, ByVal lBufferLength As Long) As Long
...
(ByVal hInternet As Long, ByVal lOption As Long, ByRef sbuffer As Any, ByRef lBufferLength As Long) As Long
...
#End If 'Last part of WININET functions
